...
internal sealed class LfuCacheOptionsValidator : IValidateOptions<LfuCacheOptions>
{
    ...
    public ValidateOptionsResult Validate(string? name, LfuCacheOptions options)
    {
        return TryValidate(options, out var failures)
            ? ValidateOptionsResult.Success
            : ValidateOptionsResult.Fail(failures);
    }

    internal static bool TryValidate(LfuCacheOptions options, out string[] failures)
    {
